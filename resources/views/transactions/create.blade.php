        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('transactions.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('kode_order')) has-error @endif">
                    ...
                    <input type="text" id="kode_order-field" name="kode_order" class="form-control" value="{{ old("kode_order") }}"/>
                    ...
                    <div class="form-group @if($errors->has('closing_date')) has-error @endif">
                       <label for="closing_date-field">Closing Date</label>
                    <input type="text" id="closing_date-field" name="closing_date" class="form-control date-picker" value="{{ old("closing_date") }}"/>
                    ...
                    <input type="text" id="id_product-field" name="id_product" class="form-control" value="{{ old("id_product") }}"/>
                    ...
                    <input type="text" id="id_reward-field" name="id_reward" class="form-control" value="{{ old("id_reward") }}"/>
                    ...
                    <input type="text" id="id_customer-field" name="id_customer" class="form-control" value="{{ old("id_customer") }}"/>
                    ...
                    <input type="text" id="id_member-field" name="id_member" class="form-control" value="{{ old("id_member") }}"/>
