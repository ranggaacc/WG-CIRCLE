        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('products.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group @if($errors->has('kode')) has-error @endif">
                    ...
                    <input type="text" id="kode-field" name="kode" class="form-control" value="{{ old("kode") }}"/>
                       @if($errors->has("kode"))
                    ...
                    <input type="file" id="price_list-field" name="price_list" class="form-control" value="{{ old("price_list") }}"/>
                 ...
                 <div class="form-group @if($errors->has('picture_3D')) has-error @endif">
                       <label for="price_list-field">Pictures</label>
                    <input type="file" id="picture_3D-field" name="picture_3D[]" class="form-control" value="{{ old("picture_3D") }}" multiple />
                    ...
                    <input type="number" id="progress-field" name="progress" class="form-control" value="{{ old("progress") }}"/>
                    ...
                    <input type="file" id="marketing_book-field" name="marketing_book" class="form-control" value="{{ old("marketing_book") }}"/>
                       @if($errors->has("marketing_book"))
                        <span class="help-block">{{ $errors->first("marketing_book") }}</span>
                       @endif
                    </div>
                    <div class="form-group @if($errors->has('alamat')) has-error @endif">
                    <label for="lokasi_lat-field">Address</label>
                 ...
                 <div class="form-group @if($errors->has('lokasi_lat')) has-error @endif">
                    ...
                    <input type="text" id="lokasi_lat-field" name="lokasi_lat" class="form-control" value="{{ old("lokasi_lat") }}"/>
                 ...
                 <div class="form-group @if($errors->has('lokasi_long')) has-error @endif">
                    ...
                    <input type="number" id="lokasi_long-field" name="lokasi_long" class="form-control" value="{{ old("lokasi_long") }}"/>
