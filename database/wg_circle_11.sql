...
--
-- Host: 127.0.0.1
-- Generation Time: 14 Mar 2018 pada 06.05
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
--
-- Struktur dari tabel `customer_aktif`
--

CREATE TABLE IF NOT EXISTS `customer_aktif` (
`id` int(10) NOT NULL,
...
--
-- Dumping data untuk tabel `customer_aktif`
--
...
--
-- Struktur dari tabel `customer_pasif`
--

CREATE TABLE IF NOT EXISTS `customer_pasif` (
`id` int(10) NOT NULL,
  `first_name` varchar(200) DEFAULT NULL,
  `middle_name` varchar(150) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
...
--
-- Dumping data untuk tabel `customer_pasif`
--
...
--
-- Struktur dari tabel `info_program`
--
...
--
-- Dumping data untuk tabel `info_program`
--
