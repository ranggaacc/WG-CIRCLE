        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('artikels.update', $artikel->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    ...
                    <input type="text" id="kategori-field" name="kategori" class="form-control" value="{{ is_null(old("kategori")) ? $artikel->kategori : old("kategori") }}"/>
                    ...
                    <textarea class="form-control" id="description-field" rows="3" name="description">{{ is_null(old("description")) ? $artikel->description : old("description") }}</textarea>
                    ...
                    <input type="file" id="picture-field" name="picture" class="form-control" value="{{ is_null(old("picture")) ? $artikel->picture : old("picture") }}"/>
