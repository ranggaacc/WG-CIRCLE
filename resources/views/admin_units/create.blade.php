  ...
  <section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin_units.store') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <div class="form-group @if($errors->has('id_card')) has-error @endif">
                       <label for="id_card-field">Nomor Induk Pegawai (NIP)</label>
                    ...
                    <input type="date" id="birthdate-field" name="birthdate" class="form-control date-picker" value="{{ old("birthdate") }}"/>
