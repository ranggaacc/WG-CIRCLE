  ...
  <section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('rewards.update', $reward->id) }}" enctype="multipart/form-data" method="POST">
                ...
                <label for="id_product-field">Jenis Referensi</label>
                    ...
                    <div class="form-group @if($errors->has('name')) has-error @endif">
                       ...
                       @if($errors->has("name"))
                        <span class="help-block">Pilih Segmentasi</span>
                       @endif
                    </div>
                    ...
                    <input type="number" id="value-field" name="value" class="form-control" value="{{ is_null(old("value")) ? $reward->value : old("value") }}"/>
                       @if($errors->has("value"))
                    ...
                    <input type="number" id="value-field" name="status" class="form-control" value="{{ is_null(old("status")) ? $reward->status : old("status") }}"/>
                       @if($errors->has("status"))
                        <span class="help-block">{{ $errors->first("starus") }}</span>
                       @endif
                    </div>
